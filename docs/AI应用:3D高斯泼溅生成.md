...
```curl
curl --location --request POST 'https://www.runninghub.ai/openapi/v2/run/ai-app/2062753529172938753' \
  ...
  "nodeInfoList": [
    {
      "nodeId": "18",
      "fieldName": "image",
      "fieldValue": "c13efb2cff7c46486b666d557859acd7137dfc960ac0da55778729aaaaaa9415.png",
      "description": "image"
    }
  ],
