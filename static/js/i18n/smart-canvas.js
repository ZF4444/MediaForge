(function(){
    ...
    window.StudioI18n.register({
        ...
        "smart.modelLocked": { zh: "没有权限使用该模型，请联系管理员开放", en: "You don't have permission to use this model. Contact an admin." },
        ...
        "smart.rhParams": { zh: "工作流参数", en: "Workflow Params" },
        ...
        "smart.rhNeedFields": { zh: "请先在 API 设置里编辑并保存这个工作流参数", en: "Edit and save this workflow config in API Settings first" },
