...
from .skills import list_enabled_skill_summaries, read_skill, read_skill_resource

class SkillBackend:
    def list(self): return list_enabled_skill_summaries()
    def read(self, name: str) -> str: return read_skill(name)
    def read_resource(self, name: str, path: str): return read_skill_resource(name, path)
