...
//   这一点。如果 utils.js 用 export，canvas.js 里对应就要用 import，
//   而只要文件里出现一行 import，整个文件就必须以 <script type="module">
//   方式加载——这会让 canvas.js 全部顶层声明失去 window 全局挂载，
